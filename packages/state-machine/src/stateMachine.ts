import { BaseAction, IQueue } from "@mental-poker-toolkit/types";
...
export type LocalTransition<TAction extends BaseAction, TContext> = (
    actionQueue: IQueue<TAction>,
    context: TContext
) => void | Promise<void>;

// A runnable transition can be directly invoked
export type RunnableTransition<TContext> = (
